...
class DBQuery {
    ...
    get_employee_by_department(data) {
        ...
        return this.db
        .promise()
        .query(`SELECT e.first_name AS 'First Name', 
    ...
    get_employee_by_manager(data) {
        ...
        .query(`SELECT e.first_name AS 'First Name', 
                ...
                AS Manager FROM employee e INNER JOIN employee manager 
    ...
    get_budget_by_department() {
        return this.db
        .promise()
        .query(`SELECT d.department_name AS "Department", 
    ...
    get_roles() {
        ...
        .query(`SELECT * r.title AS Title, 
                r.salary AS Salary, d.department_name AS Department 
                FROM role r LEFT JOIN department d 
                ON r.department_id = d.id ORDER BY Department, r.id ASC`);
    }
    get_role_by_id() {
        return this.db
        .promise()
    ...
    get_employees() {
        ...
        .query (`SELECT e.id as 'Employee_ID', 
                 ...
                 FROM employee e LEFT JOIN employee mgmt ON e.manager_id = mgmt.id  INNER JOIN role 
                 ON e.role_id = role.id  LEFT JOIN department  
